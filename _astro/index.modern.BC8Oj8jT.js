...
const d = s => String(s).split(".").map(t => String(parseInt(t || "0", 10))).concat(["0", "0"]).slice(0, 3).join(".");
class y {
    constructor() {
    ...
    _afterUnmount() {}
    _checkRequirements() {
        return typeof this.requires != "object" || Object.entries(this.requires).forEach(([t, r]) => {
            if (! function(e, i, u) {
                    ...
                    return !!g && ((a, h) => h.every(c => {
                        ...
                        return ((w, b) => {
                            ...
                            return (v[b] || v[""])(w)
                        })((f = p, m = d(m = a), f = d(f), m.localeCompare(f, void 0, {
                            numeric: !0
                        })), l || ">=")
                    }))(g, i)
