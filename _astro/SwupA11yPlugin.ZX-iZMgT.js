    ...
    if (!(typeof window > "u" || typeof document > "u" || typeof HTMLElement > "u")) {
        ...
        try {
            ...
            t.addEventListener("focus", function(i) {
                ...
                get: function() {
                    if (navigator && typeof navigator.userAgent < "u" && navigator.userAgent && navigator.userAgent.match(/Edge\/1[7-8]/)) return s = !1;
                    s = !0
                }
            }))
        } catch {}
        if (HTMLElement.prototype.nativeFocus === void 0 && !s) {
            ...
            var n = function(i) {
                    for (var e = i.parentNode, u = [], a = document.scrollingElement || document.documentElement; e && e !== a;)(e.offsetHeight < e.scrollHeight || e.offsetWidth < e.scrollWidth) && u.push([e, e.scrollTop, e.scrollLeft]), e = e.parentNode;
                    return e = a, u.push([e, e.scrollTop, e.scrollLeft]), u
                },
                o = function(i) {
                    for (var e = 0; e < i.length; e++) i[e][0].scrollTop = i[e][1], i[e][0].scrollLeft = i[e][2];
                    i = []
                },
                r = function(i) {
...
function p(s, t) {
    return Object.keys(t).reduce((n, o) => n.replace(`{${o}}`, t[o] || ""), s || "")
}
class w {
    constructor() {
        var t;
    ...
    announce(t, n = 0) {
        return new Promise(o => {
            setTimeout(() => {
                this.region.textContent === t && (t = `${t}.`), this.region.textContent = "", this.region.textContent = t, o()
            }, n)
        })
    }
}
...
function m(s) {
    let t;
    if (t = typeof s == "string" ? document.querySelector(s) : s, !(t instanceof HTMLElement)) return;
...
class S extends g {
    constructor(t = {}) {
        ...
        }, this.options = void 0, this.announcer = void 0, this.announcementDelay = 100, this.rootSelector = "body", this.handleAnchorScroll = (n, {
            hash: o
        }) => {
            const r = this.swup.getAnchorElement(o);
            r instanceof HTMLElement && m(r)
        }, this.options = h({}, this.defaults, t), this.announcer = new w
    }
    mount() {
            ...
            const u = document.documentElement.lang || "*",
                {
                    ...
                    url: d,
                    pathname: f
                } = y.fromUrl(window.location.href),
                l = (i = (e = r[u]) != null ? e : r["*"]) != null ? i : r;
            if (typeof l != "object") return;
            const c = document.querySelector(o);
            c || console.warn(`SwupA11yPlugin: No main heading (${o}) found on new page`);
            const v = c ? .getAttribute("aria-label") || c ? .textContent || document.title || p(l.url, {
                href: a,
                url: d,
                path: f
            });
