...
function gformDeleteUploadedFile(e, t, r) {
    var i, n = jQuery("#field_" + e + "_" + t),
        ...
        a = r.id,
        r = (r.remove(), n.find('input[type="file"],.validation_message,#extensions_message_' + e + "_" + t).removeClass("gform_hidden"), n.find(".ginput_post_image_file").show(), n.find('input[type="text"]').val(""), jQuery("#gform_uploaded_files_" + e).val());
    r && (r = jQuery.secureEvalJSON(r)) && (i = "input_" + t, 0 < (n = n.find("#gform_multifile_upload_" + e + "_" + t)).length ? (r[i].splice(o, 1), t = n.data("settings"), 0 === (o = r[i].length) ? (jQuery("#" + t.gf_vars.message_id).html(""), gfMultiFileUploader.toggleDisabled(t, !1)) : (jQuery("#error_" + a).remove(), o < t.gf_vars.max_files && gfMultiFileUploader.toggleDisabled(t, !1))) : r[i] = null, jQuery("#gform_uploaded_files_" + e).val(jQuery.toJSON(r)))
}
