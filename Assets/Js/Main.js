...
function PageBase(_div) {
    ...
    var _modules = [
        ...
        ["audio", ProjectAudio],
        ["home", HomeTime],
        ["centertext", TitleAnim],
        ["bottomtext", TitleAnim],
        ["projectintro", TitleAnim],
        ["projectintro", ProjectIntro],
        ["parallax", Parallax],
        ["nextproject", ProjectsEdge],
        ["form", ProjectForm]
    ];
...
function Smoothscroll() {
    ...
    var _wS = 0,
        ...
        _distBottom = 0,
        _windowW = GLB._vw,
        _windowH = GLB._reliableSh,
        _end = GLB._reliableSh,
        _speed = .1;
    var _fsModules, _resizeObserver, sX = 0,
        sY = 0,
        pX = 0,
        pY = 0,
        PIXEL_STEP = 10,
        LINE_HEIGHT = 50; //relevant for Firefox primarily
    var _resizeTimer, _whT, _render = false,
        _userWheeling = false,
    ...
    if (GLB._supportsPassive) window.addEventListener("wheel", wheeled, {
        passive: false
    });
...
function TouchscrollHelper() {
    ...
    function tup(e) {
        ...
        if (_direction == 1) {
            ...
            gsap.to(_target, 1, {
                scrollTo: {
                    x: GLB._windowScrollX + _moveSpeed * 50
                },
                ease: "cubic"
            });
        }
