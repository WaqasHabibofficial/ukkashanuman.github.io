...
"document" in self && ("classList" in document.createElement("_") && (!document.createElementNS || "classList" in document.createElementNS("http://www.w3.org/2000/svg", "g")) || function(t) {
    ...
    if ("Element" in t) {
        var e = "classList",
            ...
            l = function(t) {
                for (var e = r.call(t.getAttribute("class") || ""), n = e ? e.split(/\s+/) : [], i = 0, s = n.length; i < s; i++) this.push(n[i]);
        ...
        if (c[n] = Error[n], u.item = function(t) {
                ...
                for (var t, e = arguments, n = 0, i = e.length, s = !1; t = e[n] + "", -1 === a(this, t) && (this.push(t), s = !0), ++n < i;);
                ...
                var t, e, n = arguments,
                    ...
                    r = !1;
                do {
                    for (t = n[i] + "", e = a(this, t); - 1 !== e;) this.splice(e, 1), r = !0, e = a(this, t)
                } while (++i < s);
            ...
            try {
                ...
                void 0 !== t.number && -2146823252 !== t.number || (h.enumerable = !1, s.defineProperty(i, e, h))
            }
...
GLB.dispatchUpdate = function() {
    window.dispatchEvent(GLBEvent("LayoutUpdate", 0));
}
...
function GLBEvents(el, type, h, add, useCapture) {
    if (add) {
        if (el.addEventListener) {
            if (type == "scroll" /*|| type == "touchstart"*/ ) el.addEventListener(type, h, GLB._supportsPassive ? {
                passive: true
            } : false); //Scroll listeners on this site NEVER calls preventDefault
        ...
        if (el.removeEventListener) {
            if (type == "scroll" /*|| type == "touchstart"*/ ) el.removeEventListener(type, h, GLB._supportsPassive ? {
                passive: true
            } : false);
